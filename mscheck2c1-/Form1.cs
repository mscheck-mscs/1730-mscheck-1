...
namespace mscheck2c1_
{
    public partial class Form1 : Form
    {
       private byte byte1, byte2, byte3;
        ...
        private void byte3TextBox_TextChanged(object sender, EventArgs e)
        { }
        ...
        private void minusbutton_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception) { float3TextBox.Text = "error"; float1 = 0.0f; }
            ...
            catch (Exception) { decimal3TextBox.Text = "error"; decimal1 = 0m; }
        }
