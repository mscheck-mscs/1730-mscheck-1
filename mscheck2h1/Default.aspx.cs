...
namespace mscheck2h1
{
    public partial class _Default : Page
    {
        ...
        protected void DatCalculationButton_Click(object sender, EventArgs e)
        {
            //1
        ...
        protected void StringCalcuButton_Click(object sender, EventArgs e)
        {
