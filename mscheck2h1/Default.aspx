<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="mscheck2h1._Default" %>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                            <asp:Label ID="Label3" runat="server" Text="3) DayeTime.Today: "></asp:Label>
              ...
              <div class="form-group">
                            ...
                            <asp:TextBox ID="TextBox9a" runat="server">1/13/2013</asp:TextBox>
                            <asp:TextBox ID="TextBox9b" runat="server" Height="16px">12/12/2012</asp:TextBox>
              ...
              <div class="form-group">
                            ...
                            <asp:TextBox ID="TextBox10a" runat="server">1/13/2013</asp:TextBox>
            ...
            <div class="form-group">
                <asp:Button ID="DatCalculationButton" runat="server" Text="Date Calculations" OnClick="DatCalculationButton_Click" />
            </div>
        </div>
        <div class="col-md-6">
            <h2>String Methods</h2>
              ...
              <div class="form-group">
                            ...
                            <asp:TextBox ID="TextBox18" runat="server" Width="166px">1250 Homer Rd, Winona</asp:TextBox>
              ...
              <div class="form-group">
                            ...
                            <asp:TextBox ID="TextBox19" runat="server" Width="201px">111 1st St, LakeCity, MN 55041</asp:TextBox>
            ...
            <asp:Button ID="StringCalcuButton" runat="server" Text="String Calculations" OnClick="Button1_Click" />
        </div>
